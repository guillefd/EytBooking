	...
	public function install()
	{
		...
		$products_locations = "
			CREATE TABLE " . $this->db->dbprefix('products_locations') . " (
			  ...
			  `chat_hotmail` varchar(100) collate utf8_unicode_ci NOT NULL default '',                           
			  `chat_skype` varchar(100) collate utf8_unicode_ci NOT NULL default '', 
			  `chat_gmail` varchar(100) collate utf8_unicode_ci NOT NULL default '',
			  `social_facebook` varchar(100) collate utf8_unicode_ci NOT NULL default '',                           
			  `social_twitter` varchar(100) collate utf8_unicode_ci NOT NULL default '',                          
			  `social_google` varchar(100) collate utf8_unicode_ci NOT NULL default '',                          
			  `author_id` int(11) NOT NULL default '0',
			  `created_on` int(11) NOT NULL,
			  `updated_on` int(11) NOT NULL default 0,
			  `type` set('html','markdown','wysiwyg-advanced','wysiwyg-simple') collate utf8_unicode_ci NOT NULL,
