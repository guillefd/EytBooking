...
class Theme_Eytbooking extends Theme
{
    public $name			= 'EyTBooking';
    public $author			= 'Guillermo Dova';
    public $author_website  = 'http://www.rewrite-media.com/';
    public $website			= 'http://www.rewrite-media.com/';
    public $description     = 'Template based on Bootstrap 221';
    public $version			= '1.0';
