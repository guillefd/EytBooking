		...
		init: function() 
		{
			this.on("success", function(file, jsonResponse) 
			{
				...
				if (jsonResponse.status == true) // si server responde TRUE
				{
					...
					imageRow = generateRowImage(jsonResponse.data);
					insertRowToBlock(imageRow);
